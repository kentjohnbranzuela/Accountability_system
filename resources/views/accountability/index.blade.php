...
<div class="container mt-5">
    <div class="card shadow-lg border-0 rounded-4 p-4">
        <h2 class="text-primary fw-bold text-center mb-4">Data Entry Page</h2>
        ...
        <div class="collapse mt-4" id="addRecordForm">
            <div class="card p-4 shadow-sm border-0 rounded-3">
                <form action="{{ route('accountability.store') }}" method="POST" class="row g-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="ser_no" class="form-control rounded-3" placeholder="Serial No." required>
                    </div>
                    <div class="col-md-4">
