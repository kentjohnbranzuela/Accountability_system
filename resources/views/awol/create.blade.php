                ...
                <div class="card shadow-lg border-0 rounded-4 p-4">
                    ...
                    <div class="collapse mt-4" id="addRecordForm">
                        <div class="card p-4 shadow-sm border-0 rounded-3">
                            <form action="{{ route('awol.store') }}" method="POST" class="row g-3">
                                @csrf
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="ser_no" class="form-control rounded-3"
                                        placeholder="Serial No.">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="status" class="form-control rounded-3"
                                        placeholder="Status">
                                </div>
