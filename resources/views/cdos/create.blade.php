...
<div class="container mt-5">
    <div class="card shadow-lg border-0 rounded-4 p-4">
        <h2 class="text-primary fw-bold text-center mb-4">CDO Entry Page</h2>
        ...
        <div class="collapse mt-4" id="addRecordForm">
            <div class="card p-4 shadow-sm border-0 rounded-3">
                <form action="{{ route('cdos.store') }}" method="POST">
                    @csrf
                    <div id="cdoContainer">
                        <div class="row g-3 cdo-group">
                            <div class="col-md-4">
                    ...
                    <!-- Buttons -->
                    <div class="mt-3">
                        <button type="button" id="addMoreCDO" class="btn btn-primary">Add More</button>
                        <button type="submit" id="saveCDORecord" class="btn btn-success" disabled>Save CDO Records</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    document.getElementById('addMoreCDO').addEventListener('click', function() {
        let container = document.getElementById('cdoContainer');
        let lastGroup = document.querySelector('.cdo-group:last-of-type');
    ...
    function checkIfEmpty() {
        let container = document.getElementById('cdoContainer');
        let saveButton = document.getElementById('saveCDORecord');
        saveButton.disabled = container.querySelectorAll('.cdo-group').length === 0;
    }
