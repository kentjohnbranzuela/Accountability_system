...
<div class="container mt-5">
    <div class="card shadow-lg border-0 rounded-4 p-4">
        <h2 class="text-primary fw-bold text-center mb-4">Gingoog Entry Page</h2>
        ...
        <div class="collapse mt-4" id="addRecordForm">
            <div class="card p-4 shadow-sm border-0 rounded-3">
                <form action="{{ route('gingoogs.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mt-3">
                        ...
                        <button type="submit" id="saveRecord" class="btn btn-success" disabled>Save Records</button>
                    </div>
                </form>
            </div>
        </div>
